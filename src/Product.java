...
public class Product implements Serializable {
	...
	/**
	 * Creates a product with the inputed name, id, onHands, price, and reorder level
	 * @param name
	 * @param id
	 * @param onHands
	 * @param price
	 * @param reorderLevel
	 */
	public Product(String name, String id, int onHands, double price, int reorderLevel) {
		this.name = name;
		this.id = id;
